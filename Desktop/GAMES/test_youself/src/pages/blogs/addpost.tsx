...
// import { route } from 'next/dist/next-server/server/router';
  ...
  export default function Example() {
   ...
   async function addingpost(){
      // console.log(content);
      let desc=Object(content).level.content;
      var datat={
        ...
        <div className="w-full py-6 flex items-center justify-between border-b border-indigo-500 lg:border-none">
          <div className="flex items-center">
            ...
            <div className="hidden ml-10 space-x-8 lg:block">
              <p className="text-base font-medium text-white hover:text-indigo-50 text-3xl ">PRACTISE</p>
            </div>
          </div>
    ...
    <div className="w-1/2 bg-white rounded shadow-2xl p-8 m-4">
        <h1 className="block w-full text-center text-gray-800 text-2xl font-bold mb-6">ADD POSTS</h1>
        <form action="/" method="post">
            ...
            <div className="flex flex-col mb-4">
                ...
                <input className="border py-2 px-3 text-grey-800" type="text" name="last_name" id="category"/>
            </div>
            <div className="flex flex-col mb-4">
                <label className="mb-2 font-bold text-lg text-gray-900" >Description</label>
                {/* <textarea className="border py-2 px-3 text-grey-800"  name="email" id="description" required /> */}
            ...
            <div className="flex flex-col mb-4">
                ...
                <input className="border py-2 px-3 text-grey-800"  name="password" id="image" placeholder="Any image related to posts"/>
            </div>
            <div className="flex flex-col mb-4">
                <label className="mb-2 font-bold text-lg text-gray-900" >Reading time </label>
                <input className="border py-2 px-3 text-grey-800" type="number" name="password" id="reading_time" placeholder="time to read post in minutes"/>
            </div>
            ...
            <div className="flex flex-col mb-4">
                ...
                <input className="border py-2 px-3 text-grey-800" type="text" name="password"  id="author_name" placeholder="name of post author"/>
            </div>
            <div className="flex flex-col mb-4">
                <label className="mb-2 font-bold text-lg text-gray-900" >Any link to connect </label>
                <input className="border py-2 px-3 text-grey-800"  name="password" id="link" placeholder="any site link to connect with author"/>
            </div>
