...
const projects = [
  { name: 'Graph API', initials: 'WD', href: '#', members: 16, bgColor: 'bg-pink-600' },
  { name: 'Basics', initials: 'CPP', href: '#', members: 12, bgColor: 'bg-purple-600' },
  { name: 'Classes', initials: 'JAVA', href: '#', members: 16, bgColor: 'bg-yellow-500' },
  { name: 'Libraries', initials: 'PYTHON', href: '#', members: 8, bgColor: 'bg-green-500' },
]
...
import {
  ...
  export default function Example() {
        ...
        <div className="w-full py-6 flex items-center justify-between border-b border-indigo-500 lg:border-none">
          <div className="flex items-center">
            ...
            <div className="hidden ml-10 space-x-8 lg:block">
              <p className="text-base font-medium text-white hover:text-indigo-50 text-3xl ">NOTES</p>
            </div>
          </div>
    ...
    <div id="pdf_name_displayer">
    <div>
      <h2 className="text-gray-500 text-xs font-medium uppercase tracking-wide">NOTES</h2>
